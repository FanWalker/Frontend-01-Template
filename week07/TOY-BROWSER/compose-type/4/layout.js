...
function layout(element) {
  ...
  if (mainSpace < 0) {
    ...
    flexLines.forEach(function (items) {
      ...
      if (flexTotal > 0) {
        ...
        // step 元素间隔
        // there is no flexible flex items, which means, justifyContent shou work
  ...
  // align-items, alivargn-self
  // var crossSpace;

  if (!style[crossSize]) { // auto sizing
    crossSpace = 0;
    elementStyle[crossSize] = 0;
    for (let i = 0; i < flexLinets.length; i++) {
